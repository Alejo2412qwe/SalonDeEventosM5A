...
import { ImgProductosService } from '../service/img-productos.service';
...
export class ProductoComponent {
  ...
  constructor(private productoService: productoService, private categoriaService: CategoriaService, private tipoService: TipoService, private fileService: UploadFileService,
    private router: Router, private toastr: ToastrService, private imgProductoService: ImgProductosService) { }
  ngOnInit(): void {
    this.cargarTipos()
  }
  ////////////////////IMAGENES///////////////////////////////////
